...
// image import
import logo from "../../../assets/images/dashboard/thunder-logo.png";
	...
	return (
		<Fragment>
			<div className="page-sidebar">
				<div className="main-header-left d-none d-lg-block bg-primary">
					<div className="logo-wrapper">
						<Link to={`${process.env.PUBLIC_URL}/dashboard`}>
							<img className="blur-up lazyloaded" style={{width: '150px'}} src={logo} alt="" />
						</Link>
					</div>
				</div>
